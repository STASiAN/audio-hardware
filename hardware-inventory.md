...
_Prices: Thomann order price where purchased there; otherwise current thomann.de price (or retail estimate if not sold by Thomann). Links go to thomann.de product pages._

## 🎹 Synths, Grooveboxes & Drum Machines
...
## 🎛️ Mixers, Recording & Outboard

| Item | Description | Price |
|------|-------------|-------|
| [Mackie 1604-VLZ Pro](https://www.thomann.de/intl/search_dir.html?sw=Mackie+1604+VLZ) | 16-channel analog mixer | 688 € * |
| [Pioneer DJ DJM-A9](https://www.thomann.de/intl/search_dir.html?sw=DJM-A9) | 4-channel flagship DJ mixer (discontinued @ Thomann) | ~2.499 € † |
| [Tascam Model 24](https://www.thomann.de/intl/tascam_model_24.htm) | 22-ch analog mixer + 24-track recorder + USB interface | 1.129 € |
| [Tascam RC-1F](https://www.thomann.de/intl/tascam_rc_1f.htm) | Footswitch for Model 24 | 40 € |
| [DBX 266 XS](https://www.thomann.de/intl/dbx_266_xs.htm) | Stereo compressor / gate, 19" 1U | 134 € |

## 🎚️ Turntables & DJ

| Item | Description | Price |
|------|-------------|-------|
| [Technics SL-1210 MK7](https://www.thomann.de/intl/technics_sl_1210_mk_7.htm) ×2 | Direct-drive DJ turntable | 949 € ea (1.898 €) * |
| [UDG Flight Case DJM A9](https://www.thomann.de/intl/udg_flight_case_djm_a9.htm) | Flight case for Pioneer DJM-A9 | 239 € |
| [UDG Flight Case Turntable MK2 BK](https://www.thomann.de/intl/udg_flight_case_turntable_mk2_bk.htm) | Universal turntable flight case | 185 € |
| [UDG Sling Bag Trolley Deluxe B/O](https://www.thomann.de/intl/udg_sling_bag_trolley_deluxe_b_o.htm) | Record trolley bag (~60 records) | 189 € |
...
## 🎹 Keyboards, Controllers & Piano

| Item | Description | Price |
|------|-------------|-------|
| [Yamaha YDP-145 WH Arius](https://www.thomann.de/intl/yamaha_ydp_145_wh_arius.htm) | 88-key weighted digital piano (white) | 839 € |
| [Arturia Keystep 37](https://www.thomann.de/intl/arturia_keystep_37.htm) | 37-key MIDI controller + sequencer/arp | 166 € |
...
\* Current thomann.de price (item bought elsewhere / not from a Thomann order).
† Not sold at Thomann — retail estimate.
